      ...
      <div className="min-w-0">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-2">
          <a
            ...
            rel="noreferrer"
            aria-label="LinkedIn"
            className="inline-flex size-9 items-center justify-center rounded-md border border-border text-muted-foreground hover:border-foreground hover:text-foreground"
          >
